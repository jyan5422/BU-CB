-- GENERATED from core.lua by smods/gen_core_shared.sh -- do not edit.
-- Upstream's ChallengeMod table init and nativefs initChallenges() are
-- dropped; ChallengeMod.lua owns both under SMODS.
